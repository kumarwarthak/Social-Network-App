...
class _UploadPageState extends State<UploadPage> with AutomaticKeepAliveClientMixin<UploadPage>{
        ...
        title: Text("New Post",style: TextStyle(color: Colors.white,fontWeight:FontWeight.bold),),
          children: <Widget>[
            ...
            SimpleDialogOption(
              ...
              onPressed: pickIamgeFromGallery,
            ),
            SimpleDialogOption(
        ...
        children: <Widget>[
          ...
          Padding(padding: EdgeInsets.only(top: 20.0),
            ...
            shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(9.0),),
             child: Text("Upload Iamge",style: TextStyle(color: Colors.white,fontSize: 20.0,),),
              color: Colors.green,
              onPressed: ()=> takeIamge(context)
  ...
  compressingPhoto() async{
    ...
    final compressedIamgeFile= File('$path/img_$postId.jpg')..writeAsBytesSync(ImD.encodeJpg(mImageFile,quality: 90));
    setState(() {
    file = compressedIamgeFile;
    });
  }
  ...
  controlUploadAndSave() async{
    ...
    String downloarUrl =await uplaodPhoto(file);

    savePostInfoToFireStore(url:downloarUrl, location:locationTextEditingController.text, description: descriptionTextEditingController.text);
    locationTextEditingController.clear();
    descriptionTextEditingController.clear();
    setState(() {
      file=null;
  ...
  savePostInfoToFireStore({String url,String location, String description}){
    postReference.document(widget.gCurrentUser.id).collection("usersPosts").document(postId).setData({
      "postId":postId,
      "owernId":widget.gCurrentUser.id,
      "timesnap":timesnap,
      "Likes":{},
 ...
 Future<String> uplaodPhoto(mImageFile) async{
  StorageUploadTask mStorageUploadTask = storageReference.child("poast_$postId.jpg").putFile(mImageFile);
            ...
            width: 250.0,
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: "Say something about you image.",
